		 ...
		 <div class="user">
		   <!--user information-->
		    <div class="profile-container">
		       <div class="user_logo" id='user-logo'>C</div>
		       <p class="name" id='main-name'>Counselor</p>
		       <div class="info"><i class="fa-solid fa-right-from-bracket"></i></div>
  ...
  <path fill-rule="evenodd" d="M8 1a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM3 5a5 5 0 1 1 5.5 4.975V12h2a.5.5 0 0 1 0 1h-2v2.5a.5.5 0 0 1-1 0V13h-2a.5.5 0 0 1 0-1h2V9.975A5 5 0 0 1 3 5z"/>
	 ...
	 <div class='Record-Content'>
		...
		<div class="average_page">
			<div class="page_back"><i class="fa-sharp fa-solid fa-rotate-left"></i></div>
     ...
     <!--view profile of student-->
		<div class="Data-Content" id="data-content-record">
			<div class="back-button-records" id="back-button-table-records"><i class="fa-sharp fa-solid fa-rotate-left"></i></div>  
		...
		<div class="edit-content" id="assessment-edit-page">
			<div class="container-edit-content">
				...
				<form>
					<div class="input-holder">Questions<input class="questionare" id="edit_recommendation" type="text" ></div>
	...
	<div class='Inbox-Content'>
		...
		<div class='message-chat'>
			...
			<div class='chatbox' id='chatbox'>
				...
				<div class='minimize'><i class="fa-solid fa-xmark"></i></div>
					...
					<table class="table-striped">
					 <thead>
						<tr>
						  ...
						  <th scope="col" colspan="3">Student Information</th>
						  <th scope="col" colspan="4">Mental Health Issue</th>
					  ...
					  <thead>
						<tr>
						  ...
						  <th scope="col">Sleep Disorder</th>
						</tr>
					  </thead>
