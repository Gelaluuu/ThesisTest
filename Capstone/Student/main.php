   ...
   <div class="Container">
		...
		<li onclick="isclick(3)" class="Assessment-button">
		  <a href="#"> 
		     <span class="Icon Assessment_icon">
				<svg class='assessment-icon' xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 -50 450 630"><path d="M368,32H144A64.07,64.07,0,0,0,80,96V416a64.07,64.07,0,0,0,64,64H368a64.07,64.07,0,0,0,64-64V96A64.07,64.07,0,0,0,368,32ZM256,304H176a16,16,0,0,1,0-32h80a16,16,0,0,1,0,32Zm80-80H176a16,16,0,0,1,0-32H336a16,16,0,0,1,0,32Zm0-80H176a16,16,0,0,1,0-32H336a16,16,0,0,1,0,32Z"></path></svg>
			 </span>
		 ...
		 <div class="user">
		   <!--user information-->
		    <div class="profile-container">
		       ...
		       <div class="info"><?xml version="1.0" ?><svg viewBox="0 0 24 24" style="fill:white;" xmlns="http://www.w3.org/2000/svg"><g><path d="M0 0h24v24H0z" fill="none"/><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2a9.985 9.985 0 0 1 8 4h-2.71a8 8 0 1 0 .001 12h2.71A9.985 9.985 0 0 1 12 22zm7-6v-3h-8v-2h8V8l5 4-5 4z"/></g></svg></div>
			   <div class="logouthold" id="logout_hold">
					<div class="U-data">Student</div>
					<li onclick="isclick(6)" class="Logout-button"><a href="logout.php">Logout</a></li>
			   </div>
		    </div>
			<!--make a log out button here-->
		 </div>
	     </div> 
		   ...
		   <div class='Table'>
			 <div class='institution_ dashboard'>
			   <div class='institution-body'>
				 ...
				 <div class='institution-title'>Hello,<p id='user-first'></p></div>
			   </div>
			  ...
			  <div class='profile_ dashboard' ><a href='#' onclick='isclick(1)'><span class="Icon Profile_icon">
			  ...
			  <div class='inbox_ dashboard' ><a href='#' onclick='isclick(2)'><span class="Icon Inbox_icon">
			  ...
			  <div class='assessment_ dashboard' ><a href='#' onclick='isclick(3)'><span class="Icon Assessment_icon">
			 ...
			 </span>Assessment</a></div>
			  <div class='history_ dashboard' ><a href='#' onclick='isclick(4)'><span class="Icon History_icon">
				<svg class='history-icon' xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="40 -100 290 680"><path d="M256 0C 397.4 0 512 114.6 512 256C 512 397.4 397.4 512 256 512C 201.7 512 151.2 495 109.7 466.1C 95.2 455.1 91.64 436 101.8 421.5C 111.9 407 131.8 403.5 146.3 413.6C 177.4 435.3 215.2 448 256 448C 362 448 448 362 448 256C 448 149.1 362 64 256 64C 202.1 64 155 85.46 120.2 120.2L120.2 120.2L151 151C 166.1 166.1 155.4 192 134.1 192L134.1 192L24 192C 10.75 192 0 181.3 0 168L0 168L0 57.94C 0 36.56 25.85 25.85 40.97 40.97L40.97 40.97L74.98 74.98C 121.3 28.69 185.3 0 255.1 0L255.1 0L256 0zM256 128C 269.3 128 280 138.7 280 152L280 152L280 246.1L344.1 311C 354.3 320.4 354.3 335.6 344.1 344.1C 335.6 354.3 320.4 354.3 311 344.1L311 344.1L239 272.1C 234.5 268.5 232 262.4 232 256L232 256L232 152C 232 138.7 242.7 128 256 128z"></path></svg>
			 </span> History</a></div>
			  <div class='setting_ dashboard' ><a href='#' onclick='isclick(5)'><span class="Icon Setting_icon" >
		   ...
		   <div class='Date_Notification_Table'>
			  ...
			  <!--display month-->
				<div class="calendar_body">
					<div class="month">
						<div class="fas fa-angle-left prev" style="font-size:30px; position:relative; left: 13px;"></div>
						<div class="currmonth">
							<div><h1></h1></div>
							<div><p></p></div>
						</div>
						<div class="fas fa-angle-right next"style="font-size:30px; position:relative; left: -13px;" ></div>
					</div>
					<!--display weekdays-->
					<div class="weekdays">
						<div>Sun</div>
		   ...
		   <div class='User-Profile'>
				...
				<div class="information">
				 <div class='Personal-information'>
					<div class ="information-holder">
						<div class='user-personal-data'><p>First Name</p>:<p class='user-first' id='user-first-n'></p></div>
				...
				<!-- <div class='Status-data'>
					<div class ="status-holder">
						<div class='user-personal-data'><p>Stress</p>:<p class='user-stress' id='user-stress'></p></div>
						<div class='user-personal-data'><p>Anxiety</p>:<p class='user-anxiety' id='user-anxiety'></p></div>
						<div class='user-personal-data'><p>Depression</p>:<p class='user-depression' id='user-depression'></p></div>
						<div class='user-personal-data'><p>Sleep Disorder</p>:<p class='user-sleep-disorder' id='user-sleep-disorder'></p/></div>
					</div>
				 </div>-->
			    </div>
			</div>		 
	  ...
	  <!--start of inbox body-->
	     <div class='Inbox-Content'>
			...
			<div class='tools' id='tools'>
				...
				<button class='archive'  onclick='archiveshow()'>Archives<i class="fa-solid fa-box-archive"></i></button>
				...
				<button class="show-chats" id="show-chats">Message</button>
			</div>
			<div class='message-chat'>
				...
				<div class='chatbox'>
					<div class='systemad-icon' id="icon_"></div>
					<div class='systemad-name'>Counselor</div>
					<button class="hide-chats" id="hide-chats"><i class="fa-sharp fa-solid fa-circle-xmark"></i></button>
	...
	<div class='History-Content'>
	     ...
	     <div class='Setting-Content'>
			<div class="settings-title">Settings</div>
			 <div class='Setting_title'>
			   ...
			   <!--set the before css-->
					<div class='archives'><i><</i></div>
					<div class='archives-list'  id='archives-list'></div>
			   </div>
			   <!--end of archive list container-->
			   <div class='change-password-container'>
			        <div class='back-button'><i><</i></div>
					<div class='form-container'>
						<div class="form-accounts">
							<br>
							<div class='cotainer-box'>
								<label for='change-password'>new password</label><br>
								<input class='change-password' id="new-password"  type='password'>
								<div class="fa fa-eye-slash" id="show-new"></div>
							</div>
							<br>
							<div class='cotainer-box'>
								<label for='new-password'>rewrite password</label><br>
								<input class='new-password' id="rewrite-password" type='password'>
								<div class="fa fa-eye-slash" id="show-rewrite"> </div>
							</div>
							<br>
							<div class='submit-button'>
								<input type='button' id="submit-password" value='Submit'>
							</div>
						</div>
					</div>
			   </div>
	 ...
	 <!--end main body-->
		 ...
		 <div id="terms-and-conditions" style="padding: 80px;
    position: absolute;
    z-index: 1;
    top: -5px;
    height: 100%;display:none;">
		...
		<div class="container-fluid" style="display:flex;justify-content:center;align-items:center;height:100%;">
			<form id="tandap_form" >
				...
				<label for="tandap" value="">
					<input type="checkbox" id="tandap">
					Terms and Condition & Privacy Policy
				</label><br>
				<input type="submit" id="accept_b" value="Accept"> 
			</form>
